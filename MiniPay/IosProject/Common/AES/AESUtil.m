...
+(NSString *)changePsamNo:(NSString *)psamNo{
    ...
    NSString *first=[NSString stringWithFormat:@"%ld",strtoul([[psamNo substringWithRange:NSMakeRange(0, 2)] UTF8String],0,16)];
    NSString *sec=[NSString stringWithFormat:@"%ld",strtoul([[psamNo substringWithRange:NSMakeRange(2, 2)] UTF8String],0,16)];
    
    NSString *t1=[NSString stringWithFormat:@"%c",[first intValue]];
    NSString *t2=[NSString stringWithFormat:@"%c",[sec intValue]];
    
    return [NSString stringWithFormat:@"%@%@%@",t1,t2,[psamNo substringWithRange:NSMakeRange(4, [psamNo length]-4)]];
