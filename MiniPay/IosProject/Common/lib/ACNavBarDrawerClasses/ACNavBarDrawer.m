...
#define ACNavBarDrawer_Height       75.f
...
- (void)createButtonsByNumber:(NSInteger)number andItemInfoArray:(NSArray *)array
{
   ...
   // CGFloat barItem_center_y = (ACNavBarDrawer_Height / 2.f);
     CGFloat barItem_center_y =50.0f;
    
    // button 宽高
    CGFloat btn_w = barItem_w;
    CGFloat btn_h = ACNavBarDrawer_Height;
...
- (void)closeNavBarDrawer
{
    ...
    [UIView animateWithDuration:ACNavBarDrawer_Duration animations:^{
        ...
        [_mask setAlpha:0.f];
        [self setCenter:CGPointMake( (App_Frame_Width / 2), -(ACNavBarDrawer_Height-50 / 2.f) )];
