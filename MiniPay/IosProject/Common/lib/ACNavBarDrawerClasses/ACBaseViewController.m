...
//    [self.navigationController.navigationBar setBackground:navBarBgImg];
    ...
    {
        [self.navigationController.navigationBar  setNavigationBarBackgroundImageName:kImage_NavigationBarBg7];
    }else{
        [self.navigationController.navigationBar  setNavigationBarBackgroundImageName:kImage_NavigationBarBg];
    }
